...
' Corrected Syntax for HFSS 2024 R2

' Launch HFSS and create new project/design
...
oEditor.CreateBox _
  ...
  Array("NAME:Attributes", "Name:=", "Substrate", "MaterialName:=", "FR4_epoxy", "SolveInside:=", false)
...
' ---------------------------
' 5) Superstrate Layer (Air block at 0.2λ0 above patch)
oEditor.CreateBox _
...
' ---------------------------
' 9) Save Project
oProject.SaveAs "QuadPortMIMO_SingleElement_CorrectedFull.aedt", true
